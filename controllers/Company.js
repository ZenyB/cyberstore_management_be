...
const getAllCompany = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({
      success: false,
      message: "something went wrong when get data from ProductType",
    });
    console.log(error);
    return [];
  }
...
//     documentSnapshot.data().tinhTrang == "Đã thanh toán"
//   ) {
//     return true;
//   }
//   return false;
...
//   const HoaDon = querySnapshot1.docs.map((x) => {
//     return x.data();
//   });
...
//       .json({
//         success: false,
//         message: "something went wrong when get data from getCTHSDT",
//       });
//     console.log(error);
//     return [];
//   }
...
//     if (
//       data.AnhSauDieuTri != null &&
//       data.AnhSauDieuTri.startsWith("uploads")
//     ) {
...
//     res.send({
//       success: true,
//       message: "CTHSDT added successfully",
//       docId: docRef.id,
//     });
//   } catch (error) {
...
//       .json({
//         success: false,
//         message: "something went wrong when adding cthsdt",
//       });
//   }
// };
...
//     });
//     const newList = list.sort((a, b) =>
//       a.maBenhNhan.localeCompare(b.maBenhNhan)
//     );
...
//       .json({
//         success: false,
//         message: "something went wrong when get data from BenhNhan",
//       });
//     console.log(error);
//     return [];
//   }
...
//         maBenhNhan === "" ||
//         normalizeText(benhnhan.maBenhNhan).includes(normalizeText(maBenhNhan));
//       const matchTenBenhNhan =
//         tenBenhNhan === "" ||
//         normalizeText(benhnhan.tenBenhNhan).includes(
//           normalizeText(tenBenhNhan)
//         );
//       const matchsoDienThoai =
//         soDienThoai === "" ||
//         normalizeText(benhnhan.soDienThoai).includes(
//           normalizeText(soDienThoai)
//         );
//       const matchCCCD =
//         CCCD === "" ||
//         normalizeText(benhnhan.CCCD).includes(normalizeText(CCCD));

//       return (
//         matchMaBenhNhan && matchTenBenhNhan && matchsoDienThoai && matchCCCD
//       );
//     });
...
//       const matchMaNhaSi =
//         MaNhaSi === "" ||
//         normalizeText(cthsdt.MaNhaSi).includes(normalizeText(MaNhaSi));
//       const matchTenNhaSi =
//         TenNhaSi === "" ||
//         normalizeText(cthsdt.TenNhaSi).includes(normalizeText(TenNhaSi));
//       const matchNgayDieuTri =
//         NgayDieuTri === "" ||
//         normalizeText(cthsdt.NgayDieuTri).includes(normalizeText(NgayDieuTri));
...
//       .json({
//         success: false,
//         message: "something went wrong when get data from cthsdt",
//       });
//     console.log(error);
//     return [];
//   }
...
//       .json({
//         success: false,
//         message: "something went wrong when get data from patient",
//       });
//   }
// };
